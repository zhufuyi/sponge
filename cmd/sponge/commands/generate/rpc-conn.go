...
// RPCConnectionCommand generate rpc connection codes
...
Examples:
  # generate rpc connection codes
  sponge micro rpc-conn --module-name=yourModuleName --rpc-server-name=user

  # generate rpc connection codes with multiple names.
  sponge micro rpc-conn --module-name=yourModuleName --rpc-server-name=name1,name2

  # generate rpc connection codes and specify the server directory, Note: code generation will be canceled when the latest generated file already exists.
