...
func main() {
	...
	flags.StringVar(&logicOut, "logicOut", "", "folder of logical template codes generated by the plugin"+
	...
	flags.StringVar(&ecodeOut, "ecodeOut", "", "folder of error code generated by the plugin, default is internal/ecode")
