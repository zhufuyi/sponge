...
var (
	...
	ErrListByLastIDUserExample   = errcode.NewError(userExampleBaseCode+8, "failed to list by last id "+userExampleName)
	ErrListUserExample           = errcode.NewError(userExampleBaseCode+9, "failed to list of "+userExampleName)
